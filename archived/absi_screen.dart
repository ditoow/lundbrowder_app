...
/// ABSI Score calculation screen
class AbsiScreen extends StatefulWidget {
  const AbsiScreen({super.key});

  @override
  State<AbsiScreen> createState() => _AbsiScreenState();
}

class _AbsiScreenState extends State<AbsiScreen> {
  void _calculate(CalculationProvider provider) {
    ...
    Navigator.pushNamed(context, AppRoutes.absiResult);
  }
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // TBSA display (auto from provider)
                      Container(
                        padding: const EdgeInsets.all(16),
                        decoration: BoxDecoration(
                      ...
                      _ToggleOption(
                        ...
                        onChanged: (value) =>
                            provider.setInhalationInjury(value),
                      ),
